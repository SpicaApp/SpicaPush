...
module.exports = async (req, res) => {
    ...
    if (typeof req.body.notificationsEnabled !== "boolean" || typeof req.body.repliesEnabled !== "boolean" || typeof req.body.mentionsEnabled !== "boolean") return res.status(400).json({ err: "badRequest" });
